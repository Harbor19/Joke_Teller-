...
function tellMe(joke) {
    function test() {
        VoiceRSS.speech({
            key: 'd475f27571594ae3a5b588d06c1be7bf',
            src: joke,
            hl: 'en-us',
            v: 'Linda',
            r: 0, 
...
// Get jokesfrom joke API
async function getJokes (){
    let joke = '';
    const apiUrl = 'https://v2.jokeapi.dev/joke/Miscellaneous,Dark,Pun,Spooky,Christmas?blacklistFlags=racist';
    try {
        ...
        tellMe(joke);
        //to disable button while a joke is being said so as not to tell two jokes at a time
        toggleButton();
        text.innerHTML = joke;
    } catch (error) {
        //Catch errors
        console.log('Oh shett!!', error)
    }
}
